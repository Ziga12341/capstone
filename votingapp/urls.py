...
urlpatterns = [
    ...
    path("group/<str:group_name>/<str:category_name>/<str:suggestion_name>/vote", views.vote, name="vote"),
    # path("group/<str:group_name>/<str:category_name>/<str:suggestion_name>/comment", views.comment, name="comment"),
]
